...
class Image(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='User', related_name='images', blank=True,
                             null=True)
    type = models.ForeignKey(ThumbnailType, on_delete=models.CASCADE, related_name='thumbnail_links', verbose_name='Type of thumbnail')
    ...
    def __str__(self):
        return f'{self.title}_{self.type.title}'


class ExpiredLink(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='User', related_name='expired_links', blank=True,
                             null=True)
